...
import LibraryServices.SingleLineItemViewHolder;
...
public class TwoLineItemViewHolder extends SingleLineItemViewHolder {
    ...
    public TwoLineItemViewHolder(@NonNull View view) {
        super(view);
        this.secondary = itemView.findViewById(com.example.projectalexandria.R.id.mtrl_list_item_secondary_text);
    }
    ...
    public static TwoLineItemViewHolder create(@NonNull ViewGroup parent) {
        return new TwoLineItemViewHolder(
                LayoutInflater.from(parent.getContext())
                        .inflate(com.example.projectalexandria.R.layout.material_list_item_two_line, parent, false));
    }
}