...
public class SingleLineItemViewHolder extends ViewHolder {
    ...
    public SingleLineItemViewHolder(@NonNull View view) {
        super(view);
        this.icon = itemView.findViewById(com.example.projectalexandria.R.id.mtrl_list_item_icon);
        this.text = itemView.findViewById(com.example.projectalexandria.R.id.mtrl_list_item_text);
    }
    ...
    public static SingleLineItemViewHolder create(@NonNull ViewGroup parent) {
        return new SingleLineItemViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(com.example.projectalexandria.R.layout.material_list_item_single_line, parent, false));
    }
}